...
class UdpServer:
    ...
    def __init__(self, port, family_addr, persist=False, timeout=3000):  # type: ignore
        self.port = port
...
def main() -> None:
    ...
    parser.add_argument('--timeout', default=3000, type=int, help='socket recvfrom timeout.')
